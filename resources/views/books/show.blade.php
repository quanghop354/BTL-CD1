            ...
            <div class="card-body text-center">
                ...
                <div class="d-grid gap-2">
                    ...
                    @else
                        ...
                        <form action="{{ route('carts.store') }}" method="POST" class="d-grid gap-2">
                            @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    @if($book->publisher)
                        <a href="{{ route('publishers.show', $book->publisher) }}" class="badge bg-info me-1 text-dark text-decoration-none" style="transition: all 0.3s;" onmouseover="this.style.opacity=0.8" onmouseout="this.style.opacity=1">{{ $book->publisher->name }}</a>
                    @else
