...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">
            {{ auth()->user()->isAdmin() ? 'Quản lý toàn bộ giao dịch mua và mượn sách.' : 'Theo dõi các yêu cầu thanh toán của bạn.' }}
        </p>
    </div>
</div>
...
@foreach($payments as $payment)
    @if(!auth()->user()->isAdmin() && $payment->payment_status === 'paid' && $payment->book)
